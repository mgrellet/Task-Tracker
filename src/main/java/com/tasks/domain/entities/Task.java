package com.tasks.domain.entities;
...
public class Task {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(id, task.id) && Objects.equals(title, task.title)
        ...
        dueDate, task.dueDate) && status == task.status && priority == task.priority
        && Objects.equals(taskList, task.taskList) && Objects.equals(created,
        task.created) && Objects.equals(updated, task.updated);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, title, description, dueDate, status, priority, taskList, created,
        updated);
  }
}
